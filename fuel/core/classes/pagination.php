...
class Pagination {
	...
	/**
	 * Creates only the page number links; no next or previous like the above function create_links.
	 *
	 * @access public
	 * @return mixed    The pagination links
	 */
	public static function create_pagenum_links()
	{
		if (static::$total_pages == 1)
		{
			return '';
