	...
	<div id="masthead">
		...
		<div class="content_pad">
			...
			<div id="bread_crumbs">
				...
				<a href="<?php echo $base_path;  ?>admin/posts" class="current_page">View Posts</a>				
			 </div> <!-- #bread_crumbs -->
			...
			<h2>Posts by <?php echo $userName; ?></h2>
				...
				<table class="data display datatable" id="example">
					...
					<?php foreach($articles as $article): ?>
						<tr class="gradeX row" style="height: 50px;">
						 
							<td>
							
								<a target="_new" href="<?php echo $base_path;  ?>article/?id=<?php echo $article['articleID']; ?>"><?php echo html_entity_decode(stripslashes($article['articleTitle'])); ?></a>
								<div class="options hidden" style="font-size: 10px; position: absolute; margin-top: -8px;"><a href="./edit?id=<?php echo $article['articleID'] ?>">Edit</a> | <a class="delete" id="<?php echo $article['articleID'] ?>" rel="facebox" href="#delete_article">Delete</a></div>
							</td>
							...
							<td><?php echo date("F j, Y", strtotime($article['startDate'])); ?></td>
						</tr>
					<?php endforeach; ?>
					</tbody>
				</table>
				
		<div id="delete_article" style="display: none">
			<h4 class="deletetitle">Delete This Post?</h4>
