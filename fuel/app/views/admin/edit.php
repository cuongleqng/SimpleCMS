<div id="top">
	...
	<div id="masthead">
		...
		<div class="content_pad">
			...
			<h1>Editing "<?php echo stripslashes($entry->articleTitle) ?>"</h1>
			
			<div id="bread_crumbs">
				<a href="<?php echo $base_path;  ?>admin">Home</a> / 
				<a href="<?php echo $base_path;  ?>admin/edit?id=<?php echo $articleID; ?>" class="current_page">Edit Post</a>				
			 </div> <!-- #bread_crumbs -->
	...
	</div> <!-- #masthead -->	<!-- html_entity_decode(stripslashes()) -->
	...
	<div id="content" class="xgrid">
		<div class="x12">
			...
			<?php echo Form::open(array('action' => $base_path .'admin/edit?id=' . $articleID .'', 'class' => 'form label-inline uniform', 'enctype' => 'multipart/form-data')); ?>
			
					<div class="field">
						<label for="ptitle">Post Title</label>
						<?php echo Form::input(array('name' => 'ptitle', 'id' => 'ptitle', 'class' => 'full', 'value' => html_entity_decode(stripslashes($entry->articleTitle)))); ?>
					</div>
					
					
					<div class="field">
						<label for="pexcerpt">Post Excerpt</label>
						<?php echo Form::textarea(array('name' => 'pexcerpt', 'id' => 'pexcerpt', 'rows' => 3, 'class' => 'full', 'value' => stripslashes($entry->articleExcerpt))); ?>
						<p class="field_help" id="charlimitinfo">You have 350 characters left.</p>
					</div>
					
					<div class="field">
						<label for="pbody">Post Body</label>
						<?php echo Form::textarea(array('name' => 'pbody', 'id' => 'pbody', 'rows' => 10, 'class' => 'full', 'value' => stripslashes($entry->articleBody))); ?>
					</div>
					...
					<label>Current Image:</label> 
						<div class="editpostimg">
							<?php 
								if($postImage != null){
									echo Asset::img($postImage, array('height' => '100', 'alt' => 'Post Image'));
								}
							?>
						</div>
					...
					<div class="field">
						...
						<?php echo Form::select('pcat', array('name' => 'pcat', 'id' => 'pcat', 'class' => 'medium', 'selected' => ($entry->articleCat -1)), $cats) ?>
					</div>
					
					<div class="field clearfix">								
						<label for="pfeature">Feature Post?</label> 								
						<?php echo Form::select('pfeature', array('name' => 'test', 'id' => 'type', 'class' => 'medium', 'selected' => ($entry->featured)), array(1 => 'No', 2 =>'Yes')) ?>
					</div>
						
					<div class="buttonrow">
						<?php echo Form::submit(array('class' => 'btn', 'value' => 'Update Post')); ?>
					</div>	
