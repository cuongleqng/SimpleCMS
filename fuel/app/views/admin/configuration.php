<div id="top">
	...
	<div id="header">
		...
		<div class="content_pad">
			...
			<ul id="nav">
				...
				<li class="nav_icon nav_current "><a href="<?php echo $base_path;  ?>admin/configuration"><span class="ui-icon ui-icon-gear"></span>Configuration</a></li>
	...
	<div id="content" class="xgrid">
		...
		<div class="x12">
			...
			<p>As of right now, we are hard at work developing this feature. Soon, you will be able to manage your website with an even finer-tooth comb. You will be able to edit frontend details, such as the website's title, widgets, and featured post(s). We'll keep you notified of any new details via the messaging system. </p>
